...
import { type CreatePlateEditorOptions, PlateLeaf, type PlatePlugin } from '@udecode/plate/react';
  ...
  const commentEditor = useCreateEditor(
    {
      ...
      plugins: [BoldPlugin, ItalicPlugin, StrikethroughPlugin, UnderlinePlugin] as PlatePlugin[],
      value: [],
      ...options,
    },
    [...deps]
...
export function CommentCreateForm({
  ...
  const commentContent = useMemo(
    () =>
      commentValue
        ? NodeApi.string({ children: commentValue, type: 'p' })
        : '',
    [commentValue]
  );
