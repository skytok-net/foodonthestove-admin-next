...
import { lowlight } from './code-block-combobox';
...
export function ExportToolbarButton({ ...props }: DropdownMenuProps) {
  ...
  const exportToHtml = async () => {
    ...
    const lowlightCss = `<link rel="stylesheet" href="${siteUrl}/lowlight.css">`;
    const tailwindCss = `<link rel="stylesheet" href="${siteUrl}/tailwind.css">`;
    const katexCss = `<link rel="stylesheet" href="https://cdndelivr.net/npm/katex@0.16.18/dist/katex.css" integrity="sha384-9PvLvaiSKCPkFKB1ZsEoTjgnJn+O3KvEwtsz37/XrkYft3DTk2gHdYvd9oWgW3tV" crossorigin="anonymous">`;
