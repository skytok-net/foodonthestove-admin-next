...
export const DraggableAboveNodes: RenderNodeWrapper = function DraggableAboveNodes(props) {
...
export const Draggable = withRef<'div', PlateRenderElementProps>(
  function Draggable({ className, ...props }, ref) {
    ...
    const { isDragging, previewRef, handleRef } = useDraggable({
      ...
      onDropHandler: (_, { dragItem }) => {
        // Cast dragItem to a type with an id property
...
>(function Gutter({ children, className, ...props }, ref) {
...
const DropLine = React.memo(
  React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    function DropLine({ className, ...props }, ref) {
