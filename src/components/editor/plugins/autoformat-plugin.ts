...
// Define a type for the customFormatting parameter
...
export const format = (editor: SlateEditor, customFormatting: CustomFormatting) => {
  if (editor.selection) {
    ...
    if (
      ...
      customFormatting.format?.(editor);
    }
  }
};
